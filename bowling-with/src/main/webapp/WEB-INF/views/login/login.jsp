	                        ...
	                        <form role="form" id="loginForm" action="/login" method="post">
	                            <fieldset>
	                                ...
	                                <div class="checkbox">
	                                    ...
	                                    <label>
	                                    	<button type="button" class="btn btn-link" style="align:left;">Sign Up</button>
	                                    </label>
	                                </div>
	                                <!-- Change this to a button or input when using this as a form -->
	                                <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/>
	                                <a href="javascript:$('#loginForm').submit();" class="btn btn-lg btn-success btn-block">Login</a>
	                            </fieldset>
	                        </form>
	                    </div>
	                </div>
